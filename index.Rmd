...
```{r,engine='bash',eval=FALSE}
conda create -n hpc-python
conda activate hpc-python
# mamba is an alternative to conda for installing packages
# resolves 'solving for environment' timeout
...
- Some costs to palatalizing (overhead):
  - changing code
