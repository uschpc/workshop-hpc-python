...
- Be careful mixing implicit and explicit parallelism
    - Explicit: Parallelization that you implement
    - Implicit: Parallelization from libraries you call
- Implicit parallel code may use more resources than intended
- Often can turn off implicit parallelism with `export OMP_NUM_THREADS=1`
...
```{r,echo=FALSE,out.width="100%"}
knitr::include_graphics("images/parallel_write.svg")
```
